...
```
pacman -S --needed networkmanager iwd nm-connection-editor inetutils wget curl openssh firewalld vsftpd reflector bmon ethtool httrack filezilla qbittorrent wavemon firefox arch-wiki-lite arch-wiki-docs
```
